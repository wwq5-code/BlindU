...
## Overview
This repository is the official implementation of BlindU, and the corresponding paper is under review.
...
| On MNIST             | Origin      | HBFU     |    VBU   |  BlindU_w  | BlindU_w/o |
| --------             | --------    | -------- | -------- | -------- | -------- |
...
From the privacy protection perspective, BlindU_w and BlindU_w/o achieve better privacy protection, lower MI and higher attacking MSE.
From the unlearning effectiveness perspective, BlindU_w and BlindU_w/o achieve a lower backdoor accuracy (good backdoor elimination) and higher model accuracy than VBU, similar model accuracy to HBFU.
From the running time perspective, VBU achieves the best efficiency and HBFU consumes the most running time.

1. To run the BlindU on MNIST, we can run
```
...
| On CIFAR10           | Origin      | HBFU     |    VBU   |  BlindU_w  | BlindU_w/o |
| --------             | --------    | -------- | -------- | -------- | -------- |
...
3. To run the BlindU on CIFAR10, we can run
```
...
| On Adult             | Origin       | HBFU     |    VBU   |  BlindU_w  | BlindU_w/o |
| --------             | --------     | -------- | -------- | -------- | -------- |
...
5. To run the BlindU on Adult, we can run
```
...
| On CIFAR100          | Origin      | HBFU     |    VBU   |  BlindU_w  | BlindU_w/o |
| --------             | --------    | -------- | -------- | -------- | -------- |
...
7. To run the BlindU on CIFAR100, we can run
```
