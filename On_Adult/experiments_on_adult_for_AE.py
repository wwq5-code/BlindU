...
print("Privacy leak attacks of MCFU_w:", infer_acc_w)
print("Backdoor Acc. of MCFU_w:", backdoor_acc_mcfu_w)
print("Acc. on test dataset of MCFU_w:", valid_acc_mcfu_w)
print("Running time (s) of MCFU_w:", train_bs_mcfu_w * avg_of_one_batch*2) # as the contain the auxiliary dataset
...
print("Privacy leak attacks of MCFU_w/o:", infer_acc_wo)
