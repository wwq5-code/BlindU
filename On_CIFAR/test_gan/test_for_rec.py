...
args.iid = True
args.model = 'z_linear'
args.local_bs = 20  #small batch_size has a better performance
args.local_ep = 10
args.num_epochs = 20
...
args.epsilon = 1.0
args.dp_sampling_size = int(32*32*0.999)
...
sampled_data, sample_labels = create_backdoor_train_dataset(dataname=args.dataset, train_data=train_set,
                                                            base_label=base_label,
                                                            trigger_label=trigger_label, poison_samples=poison_samples,
                                                            batch_size=args.local_bs, args=args,  add_backdoor=add_backdoor,dp_sample=1)
...
#
#
# print_multal_info(vibi_f_hessian, dataloader_erase,dataloader_remain, args)
#
