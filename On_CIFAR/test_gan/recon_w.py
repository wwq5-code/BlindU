...
for epoch in range(init_epoch, init_epoch + args.num_epochs+200):
    ...
    for (x, y), (x2, y2) in zip(dataloader_erase, dataloader_dp_sampled_w):
...
plt.imsave('cifar_image_beta_0001_w.png', image_rec)
plt.imsave('cifar_image_beta_0001_org_w.png', image_org)

import matplotlib.image as mpimg
# Load the image
image = mpimg.imread('cifar_image_beta_0001_w.png')
