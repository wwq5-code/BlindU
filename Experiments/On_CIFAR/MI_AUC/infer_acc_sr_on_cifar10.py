...
unl_ss_w = [0.5810, 0.6989, 0.71669, 0.73972, 0.769]  #74.78
unl_ss_wo = [0.5831, 0.71810, 0.73269, 0.769, 0.789] #71.64
...
plt.plot(x, unl_ss_wo, linestyle='--', color='g',  marker='s', fillstyle='none', markevery=markevery,
         label='BlindU$_{w/o}$',linewidth=l_w, markersize=m_s, markeredgewidth=marker_s)
...
plt.savefig('infer_acc_sr_on_cifar10.pdf', format='pdf', dpi=200)
plt.show()