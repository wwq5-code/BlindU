...
ax.imshow(image, extent=[x_coords[0]+0.05, x_coords[0]+2*index_change/5*4+0.05, unl_org_0[0], unl_org_0[0]+2*index_change/5*100], aspect='auto')
image = mpimg.imread('mnist_image_sr_001_org_wo.png')
ax.imshow(image, extent=[x_coords[1] +0.05, x_coords[1]+2*index_change/5*4+0.05, unl_org_0[1], unl_org_0[1]+2*index_change/5*100], aspect='auto')
image = mpimg.imread('mnist_image_sr_01_org_wo.png')
ax.imshow(image, extent=[x_coords[2] +0.05, x_coords[2]+2*index_change/5*4+0.05, unl_org_0[2], unl_org_0[2]+2*index_change/5*100], aspect='auto')
image = mpimg.imread('mnist_image_sr_1_org_wo.png')
ax.imshow(image, extent=[x_coords[3] +0.05, x_coords[3]+2*index_change/5*4+0.05, unl_org_0[3], unl_org_0[3]+2*index_change/5*100], aspect='auto')
